...
public final class HibernateUtilTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(sessionFactoryGenerator.getSessionFactory(path)).thenReturn(sessionFactory);
    }
    ...
    public void testGetSessionFactory() {
        assertSame(sessionFactory, HibernateUtil.getSessionFactory(path));
        assertSame(sessionFactory, HibernateUtil.getSessionFactory(path));               //Repeat.     
    }
}
