...
import com.etlsolutions.examples.data.specific.payment.AmexcardPaymentEntity;
...
/**
 * Test of class AmexcardPaymentProcessor.
 *
 ...
 * @version 1.0.0
 */
public final class AmexcardPaymentProcessorTest {
    ...
    private  AmexcardPayment amexcardPayment1;
    private  AmexcardPayment amexcardPayment2;
    private AmexcardPayment amexcardPayment3;

    private AmexcardPaymentProcessor instance;
    ...
    public void setUp() {
        ...
        SecurityCode securityCodeColumn = new SecurityCode("9647");
        SecurityCode securityCodeColumn3 = new SecurityCode("8647");
        
        amexcardPayment1 = new AmexcardPaymentEntity(cardPaymentDetailEntity, cardPersonAddressLinkEntity, paymentCardNumberColumn, expireDateColumn, securityCodeColumn);
        amexcardPayment2 = new AmexcardPaymentEntity(cardPaymentDetailEntity, cardPersonAddressLinkEntity, paymentCardNumberColumn, expireDateColumn, securityCodeColumn);
        amexcardPayment3 = new AmexcardPaymentEntity(cardPaymentDetailEntity, cardPersonAddressLinkEntity, paymentCardNumberColumn, expireDateColumn, securityCodeColumn3);
        
        
        databaseManager.clear();
        instance = new AmexcardPaymentProcessor(facade);       
    }
    ...
    public void testSave() {
        ...
        AmexcardPaymentPojo expResult = new AmexcardPaymentPojo(cardPersonAddressLink, cardPaymentDetail, "198232081901431", "9647", new Date(23489798713L));
        
        AmexcardPaymentPojo result = instance.save(amexcardPayment1);
    ...
    public void testDoSave() {
        ...
        AmexcardPaymentPojo result = instance.doSave(amexcardPayment1);
    ...
    public void testDoSave_SaveAgain() {
        AmexcardPaymentPojo expResult = instance.save(amexcardPayment1);
