...
/**
 * The ReviewSpi interface contains information of a review.
 * 
 * @param <I>
 * @param <R>
 * 
 ...
 * @version 1.0.0
 */
public interface ReviewSpi <I extends ItemCommonDetail, R extends Reviewer> extends IdentifiableReview, IdentifiableSpi {
     ...
     * @param reviewRanking 
     */
    void setReviewRanking(int reviewRanking);
