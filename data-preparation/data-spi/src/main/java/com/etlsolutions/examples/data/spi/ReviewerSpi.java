...
/**
 * The ReviererSpi interface defines
 * 
 ...
 * @version 1.0.0
 */
public interface ReviewerSpi<P extends PersonalDetail> extends IdentifiableReviewer, IdentifiableSpi {
     ...
     * @param person 
     */
    void setPersonalDetail(P person);

    /**
     * 
     * @param reviewerImage 
     */
    void setImage(byte[] reviewerImage);
