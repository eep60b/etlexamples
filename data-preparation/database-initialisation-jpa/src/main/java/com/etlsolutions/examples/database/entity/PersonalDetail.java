...
public class PersonalDetail implements Serializable {
    ...
    @OneToMany(mappedBy = "personalDetailId")
    private Set<Reviewer> reviewerSet;
    ...
    @XmlTransient
    public Set<Reviewer> getReviewerSet() {
        return reviewerSet;
    }

    public void setReviewerSet(Set<Reviewer> reviewerSet) {
    ...
    public boolean equals(Object object) {
        ...
        if ((this.personalDetailId == null && other.personalDetailId != null) || (this.personalDetailId != null && !this.personalDetailId.equals(other.personalDetailId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.etlsolutions.examples.database.entity.PersonalDetail[ personalDetailId=" + personalDetailId + " ]";
    }
