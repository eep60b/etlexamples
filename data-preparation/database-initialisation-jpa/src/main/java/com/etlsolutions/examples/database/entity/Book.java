...
@NamedQueries({
    ...
    @NamedQuery(name = "Book.findByUom", query = "SELECT b FROM Book b WHERE b.uom = :uom"),
...
public class Book implements Serializable {
    ...
    public Book(Integer bookId, String bookIsbn, int bookEdition, String uom, String bookFormat, String bookLanguage) {
        this.bookId = bookId;
    ...
    public String toString() {
        return "com.etlsolutions.examples.database.entity.Book[ bookId=" + bookId + " ]";
    }
