...
public class Administrator implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        return !((this.administratorId == null && other.administratorId != null) || (this.administratorId != null && !this.administratorId.equals(other.administratorId)));
    }

    @Override
    public String toString() {
        return "com.etlsolutions.examples.database.entity.Administrator[ administratorId=" + administratorId + " ]";
    }
