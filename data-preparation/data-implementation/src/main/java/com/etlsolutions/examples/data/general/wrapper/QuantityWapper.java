...
/**
 *
 * The QuantityWapper class represents the quantity of an certain type of items.
 * 
...
@ImmutableClass
@DataClass
public final class QuantityWapper extends TypedValueWrapper<Integer> {
    
    public QuantityWapper(int value) {
        super(value);
    }
}
