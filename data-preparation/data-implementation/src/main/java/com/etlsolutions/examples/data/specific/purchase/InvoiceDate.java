...
/**
 * The InvoiceDate class represents the invoice date column in the invoice table.
 * 
...
@ImmutableClass
@DataClass
public final class InvoiceDate extends DateWrapper {
