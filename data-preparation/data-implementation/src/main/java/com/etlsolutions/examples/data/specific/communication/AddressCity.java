...
/**
 * The AddressCity class represents the city information of an address.
 *
...
@ImmutableClass
@DataClass
public final class AddressCity extends StringWrapper {

    /**
     * Construct an object use the given city name.
     *
