...
/**
 * The AddressPostcode class represents the post code of an address.
 *
...
@ImmutableClass
@DataClass
public final class AddressPostcode extends StringWrapper {

    /**
     *
     * @param value
     */
    public AddressPostcode(String value) {
        super(value);
    }
}
