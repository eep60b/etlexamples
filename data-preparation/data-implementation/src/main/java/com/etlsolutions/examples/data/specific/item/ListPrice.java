...
/**
 * The ListPrice class represents the list price of an item.
...
@ImmutableClass
@DataClass
public final class ListPrice extends BigDecimalValueWrapper {


    
    public ListPrice(BigDecimal value) {
        super(value);
    }

    
    public ListPrice(double value) {
    ...
    /**
     * Construct a default object with the list price is zero.
     */
    public ListPrice() {
        this(0);
    }
