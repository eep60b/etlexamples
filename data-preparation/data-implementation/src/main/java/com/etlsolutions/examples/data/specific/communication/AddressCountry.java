...
/**
 * The AddressCountry class represents the country information in an address.
 *
...
@ImmutableClass
@DataClass
public final class AddressCountry extends StringWrapper {

    /**
     * Construct an object use the given country name.
     *
     * @param value - The given country name.
     */
