...
/**
 * The ReviewText class represent the review text message of an item.
 *
...
@ImmutableClass
@DataClass
public final class ReviewText extends StringWrapper {

    /**
     * The empty review message.
     */
    public static final ReviewText EMPTY = new ReviewText("");
