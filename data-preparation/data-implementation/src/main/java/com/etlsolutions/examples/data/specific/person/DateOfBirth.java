...
/**
 * The DateOfBirth is a wrapper class which wrapper a date of birth.
 *
 ...
 * @version 1.0.0
 */
public final class DateOfBirth extends DateWrapper {

    /**
     * Construct an object using the current time. 
     */
    public DateOfBirth() {
        this(new Date());
    }
