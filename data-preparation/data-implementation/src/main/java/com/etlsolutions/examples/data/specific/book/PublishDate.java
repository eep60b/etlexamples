...
/**
 * The PublishDate class represents the published date of a book.
 *
...
@ImmutableClass
@DataClass
public final class PublishDate extends DateWrapper {

    public PublishDate(Date value) {
        super(value);
    }
