...
/**
 * The AddressArea class represents the area information of an address.
 *
...
@ImmutableClass
@DataClass
public final class AddressArea extends StringWrapper {

    /**
     * Construct an object using the given address area string.
     * @param value - The given address area string.
     */
