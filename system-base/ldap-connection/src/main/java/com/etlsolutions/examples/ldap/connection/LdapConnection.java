...
public class LdapConnection {
    ...
    public static void main(String[] args) throws NamingException {
        ...
        final String ldapUsername = "cn=dealer_user@jlr.etlsolutions.com,cn=agco,ou=JLRDealers,dc=etlsolutions,dc=com";
        final String ldapPassword = "J7kjG4E6slcn3h";
    ...
    //    env.put("java.naming.ldap.attributes.binary", "objectSID");
        ...
        ctx.addToEnvironment("sessionToken", "linoafafafafafafaf");
        String s = (String) ctx.getEnvironment().get("sessionToken");
