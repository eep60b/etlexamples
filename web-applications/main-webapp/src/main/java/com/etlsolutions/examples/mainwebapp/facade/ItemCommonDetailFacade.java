...
/**
 * The ItemCommonDetailFacade class is generated automatically then modified manually.
 *
 ...
 */
@Stateless
public class ItemCommonDetailFacade extends AbstractFacade<ItemCommonDetail> {
    ...
    public ItemCommonDetailFacade() {
        super(ItemCommonDetail.class);
    }
