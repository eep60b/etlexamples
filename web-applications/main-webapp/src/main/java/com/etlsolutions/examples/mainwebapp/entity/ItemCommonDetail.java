...
public class ItemCommonDetail implements Serializable {
    ...
    @ManyToMany(mappedBy = "itemCommonDetailCollection")
    ...
    private Collection<SoldItem> soldItemCollection;
    @OneToMany(mappedBy = "itemCommonDetailId")
    ...
    @XmlTransient
    public Collection<SoldItem> getSoldItemCollection() {
        return soldItemCollection;
    }

    public void setSoldItemCollection(Collection<SoldItem> soldItemCollection) {
        this.soldItemCollection = soldItemCollection;
    }
    ...
    public String toString() {
        return "com.etlsolutions.examples.mainwebapp.entity.ItemCommonDetail[ itemCommonDetailId=" + itemCommonDetailId + " ]";
    }
