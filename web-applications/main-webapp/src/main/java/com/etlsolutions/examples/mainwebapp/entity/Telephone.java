...
public class Telephone implements Serializable {
    ...
    @ManyToMany(mappedBy = "telephoneCollection")
    private Collection<PersonalDetail> personalDetailCollection;
    ...
    @XmlTransient
    public Collection<PersonalDetail> getPersonalDetailCollection() {
        return personalDetailCollection;
    }

    public void setPersonalDetailCollection(Collection<PersonalDetail> personalDetailCollection) {
        this.personalDetailCollection = personalDetailCollection;
    }
    ...
    public String toString() {
        return "com.etlsolutions.examples.mainwebapp.entity.Telephone[ telephoneId=" + telephoneId + " ]";
    }
