...
%PR_INSTALL% //TS//%SERVICE_NAME%  --DisplayName="%SERVICE_NAME%" --Description="Met office weather service" ^
    --Install=%PR_INSTALL% ^
    --Startup=auto ^
    --Jvm="C:\Program Files\Java\jre1.8.0_151\bin\server\jvm.dll" ^
    --Classpath="C:\Programs\metd\libs\metd.jar" ^
    --StartMode=jvm ^
    --StartClass=com.etlsolutions.examples.weather.ProcrunService ^
    --StartParams="-intervalMinutes 1 -configFilePath /Programs/metd/props/config.properties" ^
    --StartMethod=start ^
    --StopMode=jvm ^
