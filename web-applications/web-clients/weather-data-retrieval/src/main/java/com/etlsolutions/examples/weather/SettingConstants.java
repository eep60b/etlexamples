...
public final class SettingConstants {
    ...
    public static final String USER_HOME = System.getProperty("user.home") + File.separator + ".weatherDataRetrieval";
    
    public static final String DEFAULT_CONFIG_FILE_PATH = USER_HOME + File.separator + "props" + File.separator + "config.properties";

    public static final String DEFAULT_DATA_DIRECTORY_PATH = USER_HOME + File.separator + "data";    
    ...
    public static final String RUNNING_CONFIG_FILE_PATH = USER_HOME + File.separator + "props" + File.separator + "running.properties";    
}
