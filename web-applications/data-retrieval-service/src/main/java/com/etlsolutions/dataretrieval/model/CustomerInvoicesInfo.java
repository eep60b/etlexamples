...
/**
 * The CustomerInvoicesInfo class
 *
 * @author Zhipeng Chang
 */

//TODO: Implementation. Add tests. Add Java docs. Add annotations.
public class CustomerInvoicesInfo {
    
    private CustomerInfo customerInfo;
    private List<InvoiceInfo> invoiceInfoList;

    public CustomerInvoicesInfo() {
    }

    public CustomerInvoicesInfo(CustomerInfo customerInfo, List<InvoiceInfo> invoiceInfoList) {
